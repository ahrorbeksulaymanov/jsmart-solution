  ...
  return (
    <div className="flex gap-[10px] items-center py-3">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M7.38 12.0001L13.12 2.06006" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M9.69001 16.0001L3.95001 6.06006" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M14.31 16H2.82999" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
